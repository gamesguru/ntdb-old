...
CREATE TABLE data.nutr_def(
    ...
    -- weighting?
    UNIQUE (tagname),
    FOREIGN KEY (user_id) REFERENCES users.users (id) ON UPDATE CASCADE
);
...
CREATE TABLE data.food_des(
    ...
    UNIQUE(gtin_UPC),
    FOREIGN KEY (user_id) REFERENCES users.users (id) ON UPDATE CASCADE,
    FOREIGN KEY (fdgrp_id) REFERENCES data.fdgrp (id) ON UPDATE CASCADE
);
-- Food-Nutrient data
CREATE TABLE data.nut_data(
    ...
    FOREIGN KEY (food_id) REFERENCES data.food_des (id) ON UPDATE CASCADE,
    FOREIGN KEY (nutr_id) REFERENCES data.nutr_def (id) ON UPDATE CASCADE
);
...
CREATE TABLE data.tag_data(
    ...
    FOREIGN KEY (food_id) REFERENCES data.food_des (id) ON UPDATE CASCADE,
    FOREIGN KEY (tag_id) REFERENCES data.tag_id (id) ON UPDATE CASCADE
);
...
CREATE TABLE data.serving(
    ...
    FOREIGN KEY (food_id) REFERENCES data.food_des(id) ON UPDATE CASCADE,
    FOREIGN KEY (msre_id) REFERENCES data.serving_id(id) ON UPDATE CASCADE
);
...
CREATE TABLE users.rda(
    ...
    FOREIGN KEY (nutr_no) REFERENCES data.nutr_def(id) ON UPDATE CASCADE,
    FOREIGN KEY (user_id) REFERENCES users.users(id) ON UPDATE CASCADE
);
...
CREATE TABLE users.recipe_dat(
    ...
    FOREIGN KEY (recipe_id) REFERENCES users.recipe_des(id) ON UPDATE CASCADE
);
-- Recipe Portions
...
CREATE TABLE users.portions(
    ...
    FOREIGN KEY (recipe_id) REFERENCES users.recipe_des(id) ON UPDATE CASCADE,
    FOREIGN KEY (portion_id) REFERENCES users.portion_id(id) ON UPDATE CASCADE
);
...
CREATE TABLE users.field_dat(
    ...
    FOREIGN KEY (nutr_id) REFERENCES data.nutr_def(id) ON UPDATE CASCADE,
    FOREIGN KEY (field_id) REFERENCES users.field_des(id) ON UPDATE CASCADE
);
...
CREATE TABLE users.exercise_logs(
    ...
    duration_min INT,
    FOREIGN KEY (user_id) REFERENCES users.users(id) ON UPDATE CASCADE,
    FOREIGN KEY (exercise_id) REFERENCES users.exercises(id) ON UPDATE CASCADE
);
...
CREATE TABLE users.trainer_users(
    ...
    FOREIGN KEY (trainer_id) REFERENCES users.users(id) ON UPDATE CASCADE,
    FOREIGN KEY (user_id) REFERENCES users.users(id) ON UPDATE CASCADE,
...
CREATE TABLE users.biometric_logs(
    ...
    FOREIGN KEY (user_id) REFERENCES users.users(id) ON UPDATE CASCADE,
    FOREIGN KEY (biometric_id) REFERENCES users.biometrics(id) ON UPDATE CASCADE
);
